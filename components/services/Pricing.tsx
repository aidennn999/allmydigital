...
const pricingPlans = [
 {
  ...
  notIncluded: ["Custom domain", "Fitur premium", "Support prioritas"],
  popular: false,
  href: "/contact",
 },
 {
  ...
  notIncluded: ["Fitur kustom khusus"],
  popular: true,
  href: "/contact",
 },
 {
  ...
  <section className="py-12 bg-gray-50 rounded-xl mb-16">
   <div className="max-w-7xl mx-auto px-4">
    ...
    <motion.div
     ...
     <p className="text-gray-600 mb-4">Butuh paket khusus atau penyesuaian?</p>
     <Link
      href="/contact"
